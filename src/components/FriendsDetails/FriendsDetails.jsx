...
// Toast handleer from Tostify 
  ...
  return (
    <div
      className="grid grid-cols-1 sm:mt-10 md:grid-cols-[1fr_2fr] gap-4
  px-4 sm:px-6 md:px-8 lg:px-16 py-10 sm:py-20 md:py-20 bg-gray-50"
    >
      {/* left */}
