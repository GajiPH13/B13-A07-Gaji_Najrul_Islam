...
const FriendsDetails = () => {
  ...
  return (
    ...
    //         Quick Check-In
    //       </p>
    //       <div className="w-full   sm:flex-row md:w-full lg:flex  justify-between items-center gap-3">
    //         <button
  ...
  px-4 sm:px-6 md:px-8 lg:px-16 py-10 sm:py-14 md:py-20 bg-gray-50"
>
  {/* left */}
    ...
    <div>
      <div className="card bg-white shadow-sm">
        ...
        <div className="card-body items-center text-center">
          ...
          <p className="line-clamp-2">"{bio}"</p>
          <p className="break-all">Prefered: {email}</p>
        </div>
      </div>
    </div>
  ...
  <div className="w-full">
    {/* stats */}
    <div className="flex flex-col md:flex-row justify-between text-center gap-3">
      <div className="bg-white px-12 py-10 shadow-sm rounded-lg w-full">
        <p className="font-semibold text-3xl text-[#244D3F]">
          {days_since_contact}
        </p>
        <p>Days Since Contact</p>
      ...
      <div className="bg-white px-20 py-10 shadow-sm rounded-lg w-full">
        <p className="font-semibold text-3xl text-[#244D3F]">{goal}</p>
        <p>Goal (Days)</p>
      </div>

      <div className="bg-white px-10 py-10 shadow-sm rounded-lg w-full">
        <p className="font-semibold text-3xl text-[#244D3F]">
          {next_due_date}
        </p>
        <p>Next Due</p>
    ...
    {/* relationship goal */}
    <div className="px-6 py-11 bg-white rounded-lg shadow-sm space-y-4 my-4">
    ...
    <div className="px-6 py-3 bg-white rounded-lg">
      ...
      {/* <div className="flex  sm:flex-row md:flex-col md:w-full lg:flex-row justify-between items-center gap-3">
        <button
          onClick={() => (
            handleToast("Call"),
            handelHistoryLog(expectedFriends, "Call")
          )}
          className="btn w-full md:w-56 h-30 flex flex-col gap-2 items-center p-4 bg-gray-50"
        >
          <img src={Call} alt="" className="w-8 h-8 object-cover" />
        ...
        <button
          onClick={() => (
            handleToast("Text"),
            handelHistoryLog(expectedFriends, "Text")
          )}
          className="btn w-full md:w-56 h-30 flex flex-col gap-2 items-center p-4 bg-gray-50"
        >
          <img src={Text} alt="" className="w-8 h-8 object-cover" />
        ...
        <button
          onClick={() => (
            handleToast("Video"),
            handelHistoryLog(expectedFriends, "Video")
          )}
          className="btn w-full md:w-56 h-30 flex flex-col gap-2 items-center p-4 bg-gray-50"
        >
          <img src={Video} alt="" className="w-8 h-8 object-cover" />
